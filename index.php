                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <div class="section-title">
                            ...
                            <p>Los mejores paquetes para tu familia.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/japon.jpg" alt="">
                            <p>JAPON</p>
                            <div class="product-details">
                                <h6>PAQUETE A JAPON CON RESERVACION DE 3 DIAS</h6>
                                <div class="price">
                                    <h6>$6,000</h6>
                                    <h6 class="l-through">$8,000.00</h6>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/newyork.jpg" alt="">
                            <p>NEW YORK </p>
                            <div class="product-details">
                                <h6>PAQUETE NEW YORK</h6>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/dubai.jpg" alt="">
                            <p>EMIRATOS ARABES</p>
                            <div class="product-details">
                                <h6>PAQUETE DUBAI</h6>
                                <div class="price">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/colombia.jpg" alt="">
                            <div class="product-details">
                                <h6>PAQUETE COLOMBIA</h6>
                                <div class="price">
                                    <h6>$150.00</h6>
                                    <h6 class="l-through">$210.00</h6>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/corea.jpg" alt="">
                            <div class="product-details">
                                <h6>PAQUETE COREA DEL SUR</h6>
                                <div class="price">
                                    <h6>$150.00</h6>
                                    <h6 class="l-through">$210.00</h6>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/disney.jpg" alt="">
                            <div class="product-details">
                                <h6>PAQUETE DISNEY LAND</h6>
                                <div class="price">
                                    <h6>$150.00</h6>
                                    <h6 class="l-through">$210.00</h6>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/roma.jpg" alt="">
                            <div class="product-details">
                                <h6>PAQUETE ROMA</h6>
                                <div class="price">
                                    <h6>$150.00</h6>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/paris.jpg" alt="">
                            <div class="product-details">
                                <h6>PAQUETE PARIS, FRANCIA</h6>
                                <div class="price">
                                    <h6>$150.00</h6>
                                    <h6 class="l-through">$210.00</h6>
                                </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <div class="section-title">
                            <h1>Mas Paquetes</h1>
                            <p>Mas Paquetes para tu familia.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/china.png" alt="">
                            <div class="product-details">
                                <h6>PAQUETE CHINA</h6>
                                <div class="price">
                                    <h6>$150.00</h6>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/egipto.jpeg" alt="">
                            <div class="product-details">
                                <h6>PAQUETE EGIPTO</h6>
                                <div class="price">
                                    <h6>$150.00</h6>
                                    <h6 class="l-through">$210.00</h6>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/veracruz.jpg" alt="">
                            <div class="product-details">
                                <h6>PAQUETE VERACRUZ</h6>
                                <div class="price">
                                    <h6>$150.00</h6>
                                    <h6 class="l-through">$210.00</h6>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="img/paquetes/orlando.jpg" alt="">
                            <div class="product-details">
                                <h6>PAQUETE A ORLANDO, UNIVERSAL STUDIO</h6>
                                <div class="price">
                                    <h6>$150.00</h6>
                                    <h6 class="l-through">$210.00</h6>
                                </div>
